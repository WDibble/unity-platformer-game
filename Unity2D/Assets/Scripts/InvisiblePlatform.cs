 ...
 * Date: 24-04-2023
 *
 * This script handles the logic for making an invisible platform visible or invisible depending on the player's visibility state.
 * It includes methods for checking the player's visibility state and updating the platform's visibility status. 
 * It also includes logic for enabling and disabling the platform's collider and updating its tag.
 */
